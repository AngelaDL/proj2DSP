...
$KAFKA_HOME/bin/kafka-topics.sh --delete --zookeeper localhost:2181 --topic query-3-input
$KAFKA_HOME/bin/kafka-topics.sh --delete --zookeeper localhost:2181 --topic query-3-output